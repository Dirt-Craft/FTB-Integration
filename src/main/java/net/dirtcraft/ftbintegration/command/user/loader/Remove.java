...
public class Remove implements CommandExecutor {
    private static final String TYPE = "LOADER_REMOVE";
    private static final String SELF = "%s %d loader-chunks from your balance.";
    private static final String OTHER = "%s %d loader-chunks from %s's balance.";
    @Nonnull
    @Override
