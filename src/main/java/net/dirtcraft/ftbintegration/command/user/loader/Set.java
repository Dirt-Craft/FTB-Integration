...
public class Set implements CommandExecutor {
    private static final String TYPE = "LOADER_SET";
    private static final String SELF = "%3$s your loader-chunks balance to %2$d.";
    private static final String OTHER = "%s %3$s's loader-chunks balance to %2$d.";
    @Nonnull
    @Override
