...
public class Give implements CommandExecutor {
    private static final String TYPE = "LOADER_ADD";
    private static final String SELF = "%s %d loader-chunks to your balance.";
    private static final String OTHER = "%s %d loader-chunks to %s's balance.";
    @Nonnull
    @Override
