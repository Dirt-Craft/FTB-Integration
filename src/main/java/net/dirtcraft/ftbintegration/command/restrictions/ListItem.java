...
public class ListItem implements CommandExecutor {
    @Nonnull
    @Override
    public CommandResult execute(@Nonnull CommandSource src, @Nonnull CommandContext args) throws CommandException {
        ...
        service.builder()
                .title(formatText("&8 Item Blacklist "))
                .contents(contents)
    ...
    public Text format(ItemType type, String color){
        String cmd = String.format("/ftbi restrict ritem %s", type.getName());
