...
public class AddDimension implements CommandExecutor {
    @Nonnull
    @Override
    public CommandResult execute(@Nonnull CommandSource src, @Nonnull CommandContext args) throws CommandException {
        ...
        boolean success = FtbIntegration.INSTANCE.getConfig().listDimension(specified);
        String template;
        if (success) template = "&aSuccessfully listed &7\"&c%s&7\"";
        else template = "&cFailed to list &7\"&c%s&7\" &8(Is it listed?)";
