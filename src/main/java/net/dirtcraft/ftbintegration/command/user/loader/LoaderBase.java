...
public class LoaderBase implements CommandExecutor {
    public static final String[] ALIASES = new String[]{"extraloaders", "bonusloaders", "loaders", "l"};
